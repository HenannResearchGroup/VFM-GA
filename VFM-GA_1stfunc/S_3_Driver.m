...
%IMPORTANT NOTICE, run the code in where the code original placed, dont change the
...
%0. If command prompt cannot write .obj, place the working directory in C:\
...
% section, dont change current foldercd D:\GA_hyper_1st_v0\GA_fort
...
%% 3 ------------- evalaute the fit by plotting against the experimental data

%1 fill in the best material parameter set output from recording file,
%vector length of 14 if using foam hyper constitutive model
theta = [41306.4666666667        43150.2000000000       0.166666666666667       2.03333333333333      -3.333333333333333E-002  0.353333333333333        10.0000000000000       0.142000000000000        1.63666666666667        2.00000000000000        7.60000000000000        22.3333333333333       0.267133333333333        1.66666666666667];
%2 click run section 
S_sub_evaluate(theta);
