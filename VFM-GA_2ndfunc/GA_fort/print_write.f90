...
module print_write
    ...
    contains
        ...
        print*,'1. Plane stress approximation of data (experimentally proven to be a must)'
        ...
        print*,'4. weight alpha between internal and external force',alpha
        if (rflag == 1) then
            if (intn == 1) then
                print*,'5. plane stress solver: bisection, reduced integration 1 integ pt'
            else
                print*,'!!!!!!!!!WARNING setup went unexpected, need to set intn=1 rflag=1'
            endif
        else
            if (intn == 4) then
                print*,'5. plane stress solver: mixed bisection+newton Raphson, 4 integ pts'
            else
                print*,'!!!!!!!!!WARNING setup went unexpected, need to set intn=4 rflag=0'
            end if
        end if
        if (ncomp == nframe) then
            print*,'6. currently only utilizing one configuration(mesh and frame) [another slot empty]'
        else
            print*,'6.1 currently utilizing 2 configs (e.g. 2 DIC exps for comp and ten separately)'
            print*,'6.2 weight on objective function of 2nd config: ',tweight
        endif
        print*,'___________________________________________________________________'
        ...
        print*,'2.1 input mesh 1 nnode:',nnode
        print*,'2.2 input mesh 2 nnode:',nnode2
        print*,'3. input mesh 1 nel:',nel
        print*,'3. input mesh 2 nel:',nel2
        print*,'4. input mesh node per element:',neln
        print*,'5. integration points:',intn
        print*,'6. input total number of frames:',nframe
        print*,'7. number of frames for first configuration',break-1
        ...
        elseif (bctype == 2) then
            print*,'9. BC type: normal experiment top bottom comp/ten (Instron)'
        elseif (bctype == 3) then
            print*,'9. BC type: three face fictional (comp test only)'
        elseif (bctype == 4) then
            print*,'9. BC type: indentation validation'
        endif
        print*,'10. Ext Int Force vector size:',group
        print*,'-------------------------------------------------------------------'
        print*,'------------------------end of info session------------------------'
        print*,'-------------------------------------------------------------------'
        print*,'FEM ref: https://solidmechanics.org/'
        print*,'GA ref:https://link.springer.com/article/10.1007/s11042-020-10139-6'
        print*,'Rinteg ref:https://www.sciencedirect.com/science/article/pii/S0045782522004509'
        print*,''
        print*,''
        print*,'-------------------------------------------------------------------'
    ...
    subroutine start_write()
        ...
        write(1,*) ''
        if (run_mode == 0) then
            write(1,*) '0. Code Mode:Debug'
        elseif (run_mode == 2) then
            write(1,*) '0. Code Mode:Run'
        endif
        write(1,*) '1. Plane stress approximation of data (experimentally proven to be a must)'
        ...
        write(1,*) '4. weight alpha between internal and external force',alpha
        if (rflag == 1) then
            if (intn == 1) then
                write(1,*) '5. plane stress solver: bisection, reduced integration 1 integ pt'
            else
                write(1,*) '!!!!!!!!!WARNING setup went unexpected, need to set intn=1 rflag=1'
            endif
        else
            if (intn == 4) then
                write(1,*) '5. plane stress solver: mixed bisection+newton Raphson, 4 integ pts'
            else
                write(1,*) '!!!!!!!!!WARNING setup went unexpected, need to set intn=4 rflag=0'
            end if
        end if
        if (ncomp == nframe) then
            write(1,*) '6. currently only utilizing one configuration(mesh and frame) [another slot empty]'
        else
            write(1,*) '6.1 currently utilizing 2 configs (e.g. 2 DIC exps for comp and ten separately)'
            write(1,*) '6.2 weight on objective function of 2nd config: ',tweight
        endif
        write(1,*) '___________________________________________________________________'
        ...
        write(1,*) '2.1 input mesh 1 nnode:',nnode
        write(1,*) '2.2 input mesh 2 nnode:',nnode2
        write(1,*) '3.1 input mesh 1 nel:',nel
        write(1,*) '3.2 input mesh 2 nel:',nel2
        write(1,*) '4. input mesh node per element:',neln
        write(1,*) '5. integration points:',intn
        write(1,*) '6. input total number of frames:',nframe
        write(1,*) '7. number of frames for first configuration',break-1
        ...
        elseif (bctype == 2) then
            write(1,*) '9. BC type: normal experiment top bottom comp/ten (Instron)'
        elseif (bctype == 3) then
            write(1,*) '9. BC type: three face fictional (comp test only)'
        elseif (bctype == 4) then
            write(1,*) '9. BC type: indentation validation'
        endif
        write(1,*) '10. Ext Int Force vector size:',group
        write(1,*) '-------------------------------------------------------------------'
        write(1,*) '------------------------end of info session------------------------'
        write(1,*) '-------------------------------------------------------------------'
        write(1,*) 'FEM ref: https://solidmechanics.org/'
        write(1,*) 'GA ref:https://link.springer.com/article/10.1007/s11042-020-10139-6'
        write(1,*) 'Rinteg ref:https://www.sciencedirect.com/science/article/pii/S0045782522004509'
        write(1,*) ''
        write(1,*) ''
        write(1,*) '-------------------------------------------------------------------'
